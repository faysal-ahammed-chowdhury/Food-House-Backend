...
export class CustomersController {
    ...
    async updatePassword(
        ...
        return await this.customersService.updatePassword(
            req.user.userId,
            updatePasswordDto,
        );
    }
    ...
    async replaceProfile(
        ...
        return await this.customersService.replaceProfile(
            req.user.userId,
            updateCustomerDto,
        );
    }
    ...
    async patchProfile(
        ...
        return await this.customersService.patchProfile(
            req.user.userId,
            updateCustomerDto,
        );
    }
    ...
    async getOrders(@Req() req: any) {
        ...
        if (!userId) {
            throw new UnauthorizedException(
                'Your session is outdated. Please log out and log in again.',
            );
        }
    ...
    async cancelOrder(
        ...
        return await this.customersService.cancelOrder(
            req.user.userId,
            orderId,
        );
    }
    ...
    async validateVoucher(
        ...
        return await this.customersService.validateVoucher(
            code,
            restaurantId,
            subtotal,
        );
